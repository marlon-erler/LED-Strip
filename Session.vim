...
silent only
silent tabonly
cd ~/Documents/Code/Projects/LED/1
...
silent! normal! zE
let &fdl = &fdl
let s:l = 151 - ((11 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
if bufexists(fnamemodify("1.ino", ":p")) | buffer 1.ino | else | edit 1.ino | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 46 - ((0 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 46
