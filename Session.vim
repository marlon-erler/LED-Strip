...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((38 * winheight(0) + 24) / 49)
...
wincmd w
argglobal
if bufexists(fnamemodify("LED-Strip.ino", ":p")) | buffer LED-Strip.ino | else | edit LED-Strip.ino | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
nmap <buffer> \hp <Plug>(GitGutterPreviewHunk)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 311 - ((44 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 311
